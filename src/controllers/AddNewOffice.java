...
/**
 * Servlet implementation class AddNewOffice
 */
...
String []floors ={"Ground Floor","1st Floor","2nd Floor","3rd Floor","4th Floor","5th Floor"};
		...
		ua.uploadOffice(request, response);
		...
		RequestDispatcher disp = request.getRequestDispatcher("/WEB-INF/views/view_customerHome.jsp");
		disp.forward(request, response);
	}
